                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <a class="dashboard-stat blue" href="{$_url}transactions/deposit/">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span class="amount" data-a-sign="{$currency->symbol} ">{Transaction::totalAmount('Income',$currency->id,'current_month')}</span>
                                        </div>
                            ...
                            <div class="col-md-3">
                                <a class="dashboard-stat blue" href="{$_url}transactions/deposit/">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span class="amount" data-a-sign="{$currency->symbol} ">{Transaction::totalAmount('Income',$currency->id,'current_week')}</span>
                                        </div>
                            ...
                            <div class="col-md-3">
                                <a class="dashboard-stat blue" href="{$_url}transactions/deposit/">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                            <span class="amount" data-a-sign="{$currency->symbol} ">{Transaction::totalAmount('Income',$currency->id,'last_30_days')}</span>
                                        </div>
