 ...
 ';
    ...
    case 'autologin':
        ...
        if($d){
            ...
            _log('Autologin Successful','Client',$d->id);
...
//                $ui->assign('_include','new');
//
//                $ui->display('wrapper_client.tpl');
