...
define('DB_USER', 'kms'); # Database Username
define('DB_PASSWORD', 'kms'); # Database Password
define('DB_NAME', 'cms'); # Database Name
define('APP_URL', 'http://localhost/cms'); # Application URL.
